    ...
    <>
      <main className="bg-gray-100 min-h-screen">
        ...
        <div className=" max-w-5xl mx-auto py-16">
          ...
          <form onSubmit={formSubmit} className="flex items-center justify-center bg-red-200 h-full">
            <div className='flex flex-col gap-[15px]'>
              <input autoComplete='false' value={name} onChange={e => setName(e.target.value)} type="text" name="name" id="name" className="shadow-md p-2 block w-[340px] sm:text-md border-gray-300 rounded-md" placeholder="sapa lu ?" />
